...
include(":dfm:inventory:feature_inventory")
...
include(":resources")
include(":dfm:inventory:inventory_presentation")
include(":dfm:category:feature_category")
include(":dfm:category:category_presentation")
